...
start cmd /k "cd Backend\services\admin && mvn spring-boot:run"
start cmd /k "cd Backend\services\parent && mvn spring-boot:run"
start cmd /k "cd Backend\services\school && mvn spring-boot:run"
start cmd /k "cd Backend\services\doctor && mvn spring-boot:run"
