...
const ConsentScreen: React.FC<ConsentScreenProps> = ({ onConsentSubmit, onBack }) => {
  ...
  const [errors, setErrors] = useState<Partial<Record<keyof ConsentData, string>>>({});
  ...
  const validateForm = (): boolean => {
    const newErrors: Partial<Record<keyof ConsentData, string>> = {};
    ...
    <div className="h-full flex flex-col">
      <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Information Card */}
          <Card className="mb-8 border-4 border-primary bg-gradient-to-r from-pink-50 to-red-50">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3 p-4 bg-white/50 rounded-lg">
                  <Shield className="w-6 h-6 text-pink-600 mt-1" />
                  <div>
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button
              ...
              className="btn-fun font-comic text-xl py-3 px-8 bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-white border-2 border-pink-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
