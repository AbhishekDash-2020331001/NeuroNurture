              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <div className="bg-gray-100 rounded-lg p-3">
                    <p className="text-sm">I need help with patient management features. Can you please assist me?</p>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <div className="bg-blue-100 rounded-lg p-3">
                    <p className="text-sm">Hello! I'd be happy to help you with patient management. What specific feature are you having trouble with?</p>
...
export default DoctorTicketChatPage;
