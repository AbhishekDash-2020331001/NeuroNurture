...
import { performanceOverviewService, type PerformanceOverview } from '@/services/performanceOverviewService';
import { Brain, RefreshCw, TrendingUp, Star, Activity, Target, Sparkles, BarChart3, Zap } from 'lucide-react';
