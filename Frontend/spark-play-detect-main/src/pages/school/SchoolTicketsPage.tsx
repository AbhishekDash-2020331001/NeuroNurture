  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button onClick={() => navigate('/school/tickets/new')} className="flex items-center gap-2">
      ...
      <div className="grid gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <Button onClick={() => navigate('/school/tickets/new')} variant="outline">
...
export default SchoolTicketsPage;
