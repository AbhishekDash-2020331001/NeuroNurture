...
export const mockPatients: Patient[] = [
  {
    ...
    name: 'Emma Thompson',
    age: 8,
    diagnosis: 'ADHD with Attention Difficulties',
    ...
    notes: 'Responds well to visual cues and positive reinforcement. Shows improvement in attention span.',
    therapyGoals: ['Improve attention span', 'Enhance focus during tasks', 'Reduce impulsivity'],
    medicalHistory: ['ADHD diagnosis at age 6', 'Previous speech therapy'],
    currentMedications: ['Methylphenidate 10mg daily']
  },
  {
    id: '2',
    name: 'Liam Rodriguez',
    ...
    autismLikelihoodIndex: 85, // High risk
    nextAppointment: '2024-01-26',
    phone: '+1 (555) 234-5678',
    address: '456 Pine Avenue, Springfield, IL 62702',
    notes: 'Excellent progress in social interaction games. Needs more work on eye contact.',
    therapyGoals: ['Improve social interaction', 'Enhance communication skills', 'Develop eye contact'],
    medicalHistory: ['ASD diagnosis at age 3', 'Occupational therapy ongoing'],
    currentMedications: ['Melatonin 3mg at bedtime']
  },
  {
    id: '3',
    name: 'Sophia Chen',
    ...
    status: 'active',
    priority: 'low',
    taskCompletionRate: 95, // 95% of tasks completed on time
    lastTaskCompletion: '3 hours ago',
    averageTaskDelay: 0.1, // 0.1 days average delay
    autismLikelihoodIndex: 15, // Very low risk
    nextAppointment: '2024-01-24',
    phone: '+1 (555) 345-6789',
    address: '789 Maple Drive, Springfield, IL 62703',
    notes: 'Outstanding progress in motor coordination games. Ready for advanced challenges.',
    therapyGoals: ['Improve fine motor skills', 'Enhance gross motor coordination', 'Build confidence'],
    medicalHistory: ['DCD diagnosis at age 5'],
    currentMedications: []
  },
  {
    id: '4',
    ...
    status: 'inactive',
    priority: 'medium',
    taskCompletionRate: 40, // 40% of tasks completed on time
    lastTaskCompletion: '5 days ago',
    averageTaskDelay: 3.5, // 3.5 days average delay
    autismLikelihoodIndex: 30, // Low risk
    nextAppointment: '2024-01-28',
    phone: '+1 (555) 456-7890',
    address: '321 Elm Street, Springfield, IL 62704',
    notes: 'Struggling with reading comprehension games. May need additional support.',
    therapyGoals: ['Improve reading comprehension', 'Enhance visual processing', 'Build reading confidence'],
    medicalHistory: ['Dyslexia diagnosis at age 7'],
    currentMedications: []
  },
  {
    id: '5',
    ...
    status: 'active',
    priority: 'high',
    taskCompletionRate: 80, // 80% of tasks completed on time
    lastTaskCompletion: '1 hour ago',
    ...
    notes: 'Great improvement in pronunciation games. Very motivated and engaged.',
    therapyGoals: ['Improve speech clarity', 'Expand vocabulary', 'Enhance communication'],
    medicalHistory: ['Speech delay identified at age 3'],
    currentMedications: []
  }
];
...
export const mockTasks: TherapeuticTask[] = [
  {
    id: '1',
    title: 'Attention Building Program',
    description: 'Comprehensive attention and focus training program for ADHD patients',
    therapyGoal: 'Improve sustained attention and reduce distractibility',
    ...
    completedCount: 0,
    priority: 'high',
    notes: 'Focus on reducing screen time distractions during sessions',
  ...
  },
  {
    ...
    description: 'Progressive motor skill training for coordination improvement',
    therapyGoal: 'Enhance fine and gross motor coordination',
    ...
    completedCount: 1,
    priority: 'medium',
    notes: 'Excellent progress in fine motor skills, continue with gross motor focus',
    createdBy: 'Dr. Sarah Johnson',
    estimatedDuration: 30
  },
  {
    ...
    description: 'Structured social skills development program',
    therapyGoal: 'Improve social communication and interaction skills',
    ...
    completedCount: 5,
    priority: 'high',
    notes: 'Patient showed remarkable improvement in social engagement',
    createdBy: 'Dr. Sarah Johnson',
    estimatedDuration: 30
  }
];
